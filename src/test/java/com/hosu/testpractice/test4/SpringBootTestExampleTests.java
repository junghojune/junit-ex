package com.hosu.testpractice.test4;
...
import com.hosu.testpractice.test3.repository.PerformanceRepository;
    ...
    Stream<DynamicTest> refactorTest() {
        return Stream.of(
            dynamicTest("공연정보 저장", () -> {
                ...
                // Then
                Performance insertedTestPerformance = performanceRepository.findByName("테스트 개발방법론 배우기");
